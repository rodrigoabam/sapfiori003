...
public section.
  ...
  types:
TT_HEADER_OV type standard table of TS_HEADER_OV .
  types:
...
TT_MENSAGEM type standard table of TS_MENSAGEM .
  ...
  begin of TS_OV_ITEM,
     ...
     PRECOTOL type P length 8 decimals 2,
  end of TS_OV_ITEM .
  types:
TT_OV_ITEM type standard table of TS_OV_ITEM .

  constants GC_HEADER_OV type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'HEADER_OV' ##NO_TEXT.
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'HEADER_OV' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ClientId' iv_abap_fieldname = 'CLIENTID' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZOV_MPC=>TS_HEADER_OV' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'HEADER_OVSet' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'PrecoTol' iv_abap_fieldname = 'PRECOTOL' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20240902002601'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'HEADER_OV'.                            "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'ClientId'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'HEADER_OV'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'PrecoTol'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'OV_Item'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            ...
                            iv_left_type        = 'HEADER_OV' "#EC NOTEXT
...
* Navigation Properties for entity - HEADER_OV
lo_entity_type = model->get_entity_type( iv_entity_name = 'HEADER_OV' ). "#EC NOTEXT
...
lo_parameter = lo_action->create_input_parameter( iv_parameter_name = 'ID_ORDERID'    iv_abap_fieldname = 'ID_ORDERID' ). "#EC NOTEXT
